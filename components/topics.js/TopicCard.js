...
export default function TopicCard({topic}){
    ...
    return(
        ...
        <div className='flex  flex-col w-[35rem] gap-5 xl:w-[30rem]'>
            <div className='w-full relative h-28 xl:h-56 lg:h-56'>
                ...
                <div className='flex gap-2 w-full items-center text-gray-secondary  text-[16px]'>
                ...
                <p className='flex gap-2 text-xs  items-center text-gray-secondary font-medium text-[16px]'>{date}</p>
                <div className='bg-yellow-500 rounded-full h-2 w-2'/>
