...
export default function Career() {
  return (
    <>
      <section className="px-6  bg-black-bg py-24 flex flex-col gap-6 xl:px-[10%] xl:flex xl:flex-row xl:justify-between xl:py-40">
        <div className="xl:w-1/2 flex flex-col gap-5 xl:gap-10">
          ...
          <Button text={"See All Positions"} styles="xl:w-2/5 w-3/5 px-0" />
        </div>

        <div className="flex flex-col gap-5 mt-10 xl:w-2/5 xl:mt-0">
          <div className="flex justify-between items-center border-b py-6">
            <p className="text-[24px] text-white w-1/2 font-montBold">
              Android Developer
            </p>
            <div className="w-1/5">
              <Image src={arrow} height={50} alt="arrow" className="cursor-pointer transition duration-300 ease-in-out hover:-translate-y-2"/>
            </div>
          </div>
          <div className="flex justify-between items-center border-b py-6">
            <p className="text-[24px] text-white w-1/2 font-montBold">
