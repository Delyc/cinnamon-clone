export const products =[
    ...
    description:"Fiona is a fintech consumer-facing website that enables users to search for financial products, discover them, and receive personalized recommendations.",
        ...
        list:["PRODUCT DEVELOPMENT",  "WEB DEVELOPMENT"],
        

    },

    { title:"Ukulele:  \n The largest ukulele tabs archive",
    description:"Ukulele is the number one ukulele community, where players of any level canfind the most complete tabs and chords. Cinnamon offered a complete platform redesign including expansions and new features, focusing on keeping the user longer on the website.",
    imageUrl:"/image/lapphone.webp",
